...
function TicTacToe() {
  const temp = Array.apply(null, Array(100)).map( function(){});
  ...
  return (
    <div className='bg-transparent w-[screen] md:p-0 p-4 h-screen overflow-hidden flex flex-col md:flex-row md:space-x-5 justify-center items-center'>
